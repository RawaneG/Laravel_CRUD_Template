            ...
            <form action="/modifier/traitement" method="POST">
              @csrf
                ...
                <div class="mb-3">
                  ...
                  <input type="text" name="prenom" value="{{ $etudiant->prenom }}" class="form-control" id="exampleInputPassword1">
                </div>
                <div class="mb-3">
                    <label for="exampleInputPassword1" class="form-label">Classe</label>
                    <input type="text" name="classe" value="{{ $etudiant->classe }}" class="form-control" id="exampleInputPassword1">
                </div>
                <div class="my-5 d-flex justify-content-evenly">
                    <input type="submit" class="btn btn-outline-dark" value="Modifier l'étudiant">
